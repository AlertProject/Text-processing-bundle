...
public:
  TWebPgToFileFetch(
   const TStr _OutFNm, const bool _OutHttpP, const bool _OutHttpBodyP,
   const bool _OutXmlP, const bool _OutXmlTextP, const bool _OutXmlUrlP,
   const bool _OutXmlToksP, const bool _OutXmlTagsP, const bool _OutXmlArgsP,
   const bool _OutTxtP, const bool _OutTxtUrlP, const bool _OutTxtTagsP,
   const bool _OutScrP,
   const bool _QuitMsgP):
    TWebPgFetch(),
    OutFNm(_OutFNm), OutHttpP(_OutHttpP), OutHttpBodyP(_OutHttpBodyP),
    OutXmlP(_OutXmlP), OutXmlTextP(_OutXmlTextP), OutXmlUrlP(_OutXmlUrlP),
    OutXmlToksP(_OutXmlToksP), OutXmlTagsP(_OutXmlTagsP), OutXmlArgsP(_OutXmlArgsP),
    OutTxtP(_OutTxtP), OutTxtUrlP(_OutTxtUrlP), OutTxtTagsP(_OutTxtTagsP),
    OutScrP(_OutScrP),
    QuitMsgP(_QuitMsgP){}
  void OnFetch(const int& FId, const PWebPg& WebPg);
  void OnError(const int& FId, const TStr& MsgStr);
