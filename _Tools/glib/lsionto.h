...
//////////////////////////////////////////////////////////////////////////
// Ontology-Algortihms
typedef enum { osatKMeans, osatCat, osatLwOntoGround } TOntoSuggestAlgType;
...
public:
    ...
    static void SuggestLwOntoGround(PBowDocBs BowDocBs, PBowDocWgtBs BowDocWgtBs, 
...
public:
    ...
    // suggests what are the possible subconcepts of a given concept
    void SuggestSubconcepts(const int& CptId, const PLwOntoGround& LwOntoGround,
        const int& NewConceptN, const bool& UnusedDocsP, TOntoConceptV& NewConceptV);
    ...
    void SuggestConceptNm(const int& CptId, const TVec<PLwOntoGround>& LwOntoGroundV, 
