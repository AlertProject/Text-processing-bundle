...
private:
	...
	public:
        ...
        void OnDelFromCache(const TInt& ValId, void* OgValCache) { }
	};
...
///////////////////////////////
// QMiner-Value-Block-Cache
// 
//   requirements for TRec:
//    - TRec()
//    - [int64 or int] GetMemUsed() const
//    - TRec(TSIn& SIn)
//    - void Load(TSIn& SIn)
...
private:
	...
	public:
        ...
        void OnDelFromCache(const TInt& BlockId, void* OgBlockCache) {
			if (ChangedP && !((TBlockCache*)OgBlockCache)->IsReadOnly()) {
				((TBlockCache*)OgBlockCache)->StoreBlock(BlockId); }
		}
	};
